...
class StockAdjustmentWorkflow(ConversationWorkflow):
    ...
    select_type = State(initial=True)
    select_item = State()
    show_current = State()
    enter_actual = State()
    enter_reason = State()
